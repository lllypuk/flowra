...
// MockMessageRepository - mok repozitoriya soobscheniy for tests
type MockMessageRepository struct {
	Messages map[uuid.UUID]*domainMessage.Message
	SaveErr  error
}

// NewMockMessageRepository creates New mok repozitoriya
...
// FindByChatID finds messages po ID chat
...
// FindThread finds tred soobscheniy
...
// CountByChatID podschityvaet messages in chate
...
// CountThreadReplies podschityvaet responses in thread
...
// GetReactionUsers returns users, postavivshih reaction
...
// contains checks, contains li stroka podstroku (case-insensitive)
...
// MockChatRepository - mok repozitoriya chats for tests
type MockChatRepository struct {
	Chats map[string]*chatapp.ReadModel
}

// NewMockChatRepository creates New mok repozitoriya chats
...
// AddChat adds chat s uchastnikami
...
// MockEventBus - mok shiny events for tests
type MockEventBus struct {
	Published []event.DomainEvent
}

// NewMockEventBus creates New mok shiny events
