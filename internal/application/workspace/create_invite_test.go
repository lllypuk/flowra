...
func TestCreateInviteUseCase_Execute_Success(t *testing.T) {
	...
	cmd := workspace.CreateInviteCommand{
		...
		ExpiresAt:   nil, // budet ispolzovano value by default (7 dney)
		MaxUses:     nil, // budet ispolzovano value by default (0 - unlimited)
	...
	// check that invayt dobavlen in workspace
